...
public class CrashCourse {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        /*
        ARRAYLISTS (need to be imported  like on line 3)
        Can be any size and has a lot of embedded functions to help
        Avoids primitive data types. Special classes for integers, doubles, booleans, and strings
        */

        ArrayList<String> arryLst = new ArrayList<>();

        arryLst.add("Hello");
        arryLst.add("Hello again");
        arryLst.add("Hello again I love Charlie Kirk btw");
        arryLst.remove(2);
